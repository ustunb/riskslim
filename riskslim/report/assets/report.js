...
// finds the strip cell of that score by comparing it with the score edges in model.score_bins
// and prints it with their score_digits decimals -- the browser derives no model fact.
(function () {
  "use strict";
  ...
  if (document.getElementById("rs-score")) {
    ...
    function update() {
      ...
      // the score is in the bin after every edge at or below it; a bin that holds no training
