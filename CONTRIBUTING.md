...
`riskslim.utils.check_cplex_installation()` validates the package version and native
...
uv run python -c 'from riskslim.utils import check_cplex_installation; print(check_cplex_installation())'
```
